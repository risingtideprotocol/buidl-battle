...
(define-constant INITIAL_SUPPLY u1000000000)    ;; 10 sBTC (10.00000000)
(define-constant FAUCET_AMOUNT u100000000)      ;; 1 sBTC (1.00000000)
...
(define-public (faucet)
    (begin
        (try! (ft-mint? sbtc-token FAUCET_AMOUNT tx-sender)) ;; Mint 1 sBTC to caller
        (ok true)
    )
)
